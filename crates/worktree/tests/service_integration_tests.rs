...
mod worktree_service_integration_tests {
    ...
    async fn worktree_service_initialize_worktree_not_found_returns_not_found_error() {
        ...
        let result = service
            .initialize_worktree(InitializeWorktreeCommand::new(nonexistent_id))
            .await;

        assert!(result.is_err());
        assert!(matches!(
            result.unwrap_err(),
            WorktreeDomainError::NotFound(_)
        ));
    }
    ...
    async fn worktree_service_suspend_worktree_transitions_to_suspended() {
        ...
        let result = service
            .suspend_worktree(SuspendWorktreeCommand::new(id.clone()))
            .await;
    ...
    async fn worktree_service_suspend_worktree_not_found_returns_not_found_error() {
        ...
        let nonexistent_id = WorktreeId::new_random();
        let result = service
            .suspend_worktree(SuspendWorktreeCommand::new(nonexistent_id))
            .await;
    ...
    async fn worktree_service_resume_worktree_transitions_to_active() {
        ...
        let result = service
            .resume_worktree(ResumeWorktreeCommand::new(id.clone()))
            .await;
    ...
    async fn worktree_service_resume_worktree_not_found_returns_not_found_error() {
        ...
        let nonexistent_id = WorktreeId::new_random();
        let result = service
            .resume_worktree(ResumeWorktreeCommand::new(nonexistent_id))
            .await;
    ...
    async fn worktree_service_resume_worktree_from_non_suspended_fails() {
        ...
        let result = service
            .resume_worktree(ResumeWorktreeCommand::new(id))
            .await;

        assert!(result.is_err());
        assert!(matches!(
            result.unwrap_err(),
            WorktreeDomainError::InvalidStateTransition(_, _)
        ));
    }
    ...
    async fn worktree_service_remove_worktree_not_found_returns_not_found_error() {
        ...
        let nonexistent_id = WorktreeId::new_random();
        let result = service
            .remove_worktree(RemoveWorktreeCommand::new(nonexistent_id))
            .await;
    ...
    async fn worktree_service_list_worktrees_returns_all_worktrees() {
        ...
        service
            .create_worktree(create_test_command(
                "wt-1",
                "/tmp/wt1",
                "/home/user/proj",
                WorktreeTypeEnum::Development,
    ...
    async fn worktree_service_list_worktrees_filtered_by_state_returns_matching_worktrees() {
        ...
        service
            .initialize_worktree(InitializeWorktreeCommand::new(worktree1.id().clone()))
            .await
            .unwrap();
        ...
        service
            .initialize_worktree(InitializeWorktreeCommand::new(worktree2.id().clone()))
            .await
            .unwrap();
    ...
    async fn worktree_service_list_worktrees_with_include_removed_returns_removed_worktrees() {
        ...
        service
            .initialize_worktree(InitializeWorktreeCommand::new(id1.clone()))
            .await
            .unwrap();
        service
            .remove_worktree(RemoveWorktreeCommand::new(id1.clone()))
            .await
            .unwrap();
    ...
    async fn worktree_service_add_metadata_updates_worktree() {
        ...
        service
            .add_metadata(&id, "environment", "test")
            .await
            .unwrap();
    ...
    async fn worktree_service_all_operations_use_domain_errors() {
        ...
        assert!(matches!(
            result.unwrap_err(),
            WorktreeDomainError::NameAlreadyExists(_)
        ));
    ...
    async fn worktree_service_suspension_state_transition_errors() {
        ...
        let result = service
            .suspend_worktree(SuspendWorktreeCommand::new(id))
            .await;
        assert!(matches!(
            result.unwrap_err(),
            WorktreeDomainError::InvalidStateTransition(_, _)
