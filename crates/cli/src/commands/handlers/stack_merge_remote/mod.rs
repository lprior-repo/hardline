//! Stack merge-remote command handler — merge PRs via forge API, no local checkout.
//!
...
//! - **Actions** (`actions.rs`): Forge API calls via ForgeClient (GitHub, Gitea, GitLab)
//!
...
pub use data::{
    MergeRemoteOptions, MergeRemoteOutput, MergeRemoteScope, MergedPr, PrBranchInfo, WaitOutcome,
};
