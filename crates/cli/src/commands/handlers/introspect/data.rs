...
pub struct IntrospectOptions {
    /// Specific command to introspect (None = show all capabilities).
        ...
        CommandInfo {
            ...
            error_conditions: vec![
                ...
                ErrorConditionInfo {
                    ...
                    resolution: "Use only alphanumeric characters, hyphens, and underscores".to_string(),
                },
            ],
            requires_init: true,
            requires_git: true,
...
mod tests {
    ...
    fn error_condition_info_serialization() {
        ...
        let deserialized: ErrorConditionInfo =
            serde_json::from_str(&json).expect("deserialize");
    ...
    fn add_command_has_required_argument() {
        ...
        assert!(add_cmd.arguments.iter().any(|a| a.name == "name" && a.required));
    }
