...
//!
//! This module provides query functions for retrieving conflict
//! resolution records from the audit log.
//!
//! # Design Principles
//!
...
pub async fn get_conflict_resolutions(
    ...
    validate_non_empty(session, "session").map_err(|e| crate::Error::ValidationFieldError {
...
pub async fn get_resolutions_by_decider(
    ...
    validate_decider(decider).map_err(|e| crate::Error::ValidationFieldError {
...
pub async fn get_resolutions_by_time_range(
    ...
    validate_timestamp(start_time).map_err(|e| crate::Error::ValidationFieldError {
        message: format!("invalid start_time: {e}"),
        field: "start_time".to_string(),
        value: Some(start_time.to_string()),
    })?;

    validate_timestamp(end_time).map_err(|e| crate::Error::ValidationFieldError {
