...
mod policies {
    ...
    fn claim_policy_config_validation() {
        let result = PolicyConfig::new(1000, 3, 100, 5000, 5, 30000);
        assert!(result.is_ok());

        assert!(PolicyConfig::new(0, 3, 100, 5000, 5, 30000).is_err());
        assert!(PolicyConfig::new(1000, 3, 0, 5000, 5, 30000).is_err());
        assert!(PolicyConfig::new(1000, 3, 100, 5000, 0, 30000).is_err());
    }
}
