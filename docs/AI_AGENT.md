...
> **Comprehensive reference for AI agents working with Hardline, beads, and the hardline toolchain.**

This document serves as the complete reference for autonomous AI agents operating within the Hardline system. It covers mandatory rules, workflows, commands, and best practices.
...
| Command | Use | Frequency |
|---------|-----|-----------|
| `hardline add <name>` | Create session + Zellij tab | New work |
| `hardline remove <name>` | Close tab + workspace | Work complete |
| `hardline list` | Show all sessions | Status check |
| `hardline whereami` | Check current location | Orient yourself |
| `hardline work <name>` | Create workspace (simpler than add) | New work |
| `hardline done` | Complete and merge work | Finish work |
...
*This document is maintained as part of the Hardline system. Last updated: 2024.*
