...
- `crates/hardline/tests/common/mod.rs` - Utilities for hardline integration tests
- `crates/hardline-core/tests/common/mod.rs` - Utilities for hardline-core integration tests
