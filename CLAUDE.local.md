...
**YOU ARE IN: `hardline/polecats/topaz/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/hardline/` (rig root) or other directories
...
**Your mail address:** `hardline/polecats/topaz`
**Your rig:** hardline
**Your Witness:** `hardline/witness`
...
| Ask Witness for help | `gt mail send hardline/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`hardline/witness`) when:
...
```bash
gt mail send hardline/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
