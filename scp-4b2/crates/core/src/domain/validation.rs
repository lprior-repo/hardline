...
/// # Examples
/// ```
/// use scp_core::domain::validation::validate_that;
///
/// let result = validate_that(42, |n| *n > 0, "must be positive");
/// assert!(result.is_ok());
///
...
/// # Examples
/// ```
/// use scp_core::domain::validation::validate_range;
///
/// let result = validate_range(5, 1, 10, "priority");
/// assert!(result.is_ok());
///
