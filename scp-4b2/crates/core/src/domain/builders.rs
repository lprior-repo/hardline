...
const fn convert_conflict_type(ty: ConflictType) -> crate::output_jsonl::ConflictType {
    match ty {
        ConflictType::Overlapping => crate::output_jsonl::ConflictType::Overlapping,
        ConflictType::Existing => crate::output_jsonl::ConflictType::Existing,
        ConflictType::DeleteModify => crate::output_jsonl::ConflictType::DeleteModify,
        ConflictType::RenameModify => crate::output_jsonl::ConflictType::RenameModify,
        ConflictType::Binary => crate::output_jsonl::ConflictType::Binary,
    }
}

const fn convert_resolution_strategy(
    strategy: ResolutionStrategy,
) -> crate::output_jsonl::ResolutionStrategy {
    match strategy {
        ResolutionStrategy::AcceptOurs => crate::output_jsonl::ResolutionStrategy::AcceptOurs,
        ResolutionStrategy::AcceptTheirs => crate::output_jsonl::ResolutionStrategy::AcceptTheirs,
        ResolutionStrategy::JjResolve => crate::output_jsonl::ResolutionStrategy::JjResolve,
        ResolutionStrategy::ManualMerge => crate::output_jsonl::ResolutionStrategy::ManualMerge,
        ResolutionStrategy::Rebase => crate::output_jsonl::ResolutionStrategy::Rebase,
        ResolutionStrategy::Abort => crate::output_jsonl::ResolutionStrategy::Abort,
        ResolutionStrategy::Skip => crate::output_jsonl::ResolutionStrategy::Skip,
    }
}
